...
public class GameManager : MonoBehaviour
{
    ...
    private List<GameObject> _mutationPool;
    ...
    private void Awake()
    {
        ...
        Instance = this;
        if (mutationLibrary == null || mutationPool.Count == 0)
        {
            ...
            _mutationPool = new List<GameObject>(mutationPool);
        }
    ...
    public void RemoveFromPool(GameObject mutation)
    {
        Instance._mutationPool.Remove(mutation);
    }
    ...
    {
        if (_mutationPool.Count != 0)
        {
            string randomMutationName = _mutationPool[Random.Range(0, _mutationPool.Count)].name;
    ...
    {
        var prefab = _mutationPool.FirstOrDefault(p => p.name == mutationName);
